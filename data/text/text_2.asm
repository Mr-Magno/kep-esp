...
_ScarletBook1::
	text "COLAGRITO"
	line "Un #MON parecido"
	cont "a JIGGLYPUFF de"
	cont "naturaleza"
	cont "salvaje."
...
_DiglettSculptureText::
	text "¡Es un butsudan!" ; restored JP elemement
	done
...
_OakSpeechText1::
	...
	line "¡Bienvenidos al"
	cont "mundo de #MON!"
	cont "Este hackrom ha"
	cont "sido traducido"
	cont "por MagnoTV"
	cont "X: SuperCard-ESP"
	cont "y CalentadasTCG"
	cont "que tiene un"
	cont "canal de YT con"
	cont "el mismo nombre."
...
_BoyGirlText::
    text "¡Escoge tu estilo!"
    done

_MysteryBoxText::
	text "¡Una misteriosa"
	line "niebla apareció!"
	prompt
